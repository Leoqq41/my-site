...
import { Home as HomeIcon, User, Activity, Gamepad2, Award, Mail, Phone, Github, Linkedin, Instagram, BookOpen } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold mb-8 text-center text-gray-800 flex items-center justify-center">
              <BookOpen className="mr-3 text-[#f48fb1]" />
              学习资源
            </h2>
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="w-24 h-24 bg-gradient-to-br from-[#f8bbd0] to-[#90caf9] rounded-full flex items-center justify-center shadow-lg">
                  <BookOpen className="text-white w-12 h-12" />
                </div>
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">Python 课程学习</h3>
                  <p className="text-gray-600 mb-4">系统学习 Python 编程基础，掌握语法、函数、面向对象和文件操作！</p>
                  <div className="flex flex-wrap gap-2 mb-4">
                      <span className="bg-[#e3f2fd] text-[#90caf9] px-3 py-1 rounded-full text-sm">入门级</span>
                      <span className="bg-[#fce4ec] text-[#f48fb1] px-3 py-1 rounded-full text-sm">4个章节</span>
                      <span className="bg-[#e8f5e8] text-[#81c784] px-3 py-1 rounded-full text-sm">含代码示例</span>
                  </div>
                </div>
                <div>
                  <Link 
                    to="/python-course"
                    className="bg-gradient-to-r from-[#f48fb1] to-[#90caf9] hover:from-[#f06292] hover:to-[#64b5f6] text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all font-semibold"
                  >
                    开始学习 →
                  </Link>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="bg-[#fce4ec] p-3 rounded-full mr-4">
                      <HomeIcon className="text-[#f48fb1]" />
                    </div>
                    <div>
